...
use crate::api::response::{
    ...
    UpdateFilteredVideoStatusResponse, UpdateVideoStatusResponse, VideoInfo, VideoResponse, VideoFullInfo, VideoFullResponse,VideosResponse,
};
...
pub(super) fn router() -> Router {
    Router::new()
        ...
        .route("/videos/bvid", get(get_video_by_bvid))        
}
